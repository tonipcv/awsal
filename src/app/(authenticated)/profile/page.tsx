      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <div className="space-y-6 lg:space-y-8">
            <div className="py-4 lg:py-6 space-y-2">
              <div className={cn(
                "h-6 lg:h-8 rounded-lg w-24 lg:w-32 animate-pulse",
                isLightTheme ? "bg-gray-200" : "bg-gray-700"
              )}></div>
              <div className={cn(
                "h-4 lg:h-5 rounded-lg w-48 lg:w-64 animate-pulse",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
              ...
              <div className="lg:col-span-2">
                <div className={cn(
                  ...
                  <div className="p-4 lg:p-6">
                    <div className={cn(
                      "h-5 lg:h-6 rounded w-36 lg:w-48 animate-pulse mb-6 lg:mb-8",
                      isLightTheme ? "bg-gray-200" : "bg-gray-700"
                    )}></div>
                    
                    {/* Profile Image Skeleton */}
                    <div className="flex flex-col items-center space-y-4 lg:space-y-6 mb-6 lg:mb-8">
                      <div className={cn(
                        "w-24 h-24 lg:w-32 lg:h-32 rounded-xl animate-pulse",
                        isLightTheme ? "bg-gray-200" : "bg-gray-700"
                      )}></div>
                      <div className="text-center space-y-2">
                        <div className={cn(
                          "h-5 lg:h-6 rounded-lg w-16 lg:w-20 animate-pulse mx-auto",
                          isLightTheme ? "bg-gray-200" : "bg-gray-700"
                        )}></div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 mb-6 lg:mb-8">
                      <div className="space-y-3">
                        <div className={cn(
                          "h-3 lg:h-4 rounded w-12 lg:w-16 animate-pulse",
                          isLightTheme ? "bg-gray-200" : "bg-gray-700"
                        )}></div>
                        <div className={cn(
                          "h-9 lg:h-10 rounded-lg border animate-pulse",
                          isLightTheme ? "bg-gray-50 border-gray-200" : "bg-gray-800/50 border-gray-700/50"
                        )}></div>
                      </div>
                      <div className="space-y-3">
                        <div className={cn(
                          "h-3 lg:h-4 rounded w-16 lg:w-20 animate-pulse",
                          isLightTheme ? "bg-gray-200" : "bg-gray-700"
                        )}></div>
                        <div className={cn(
                          "h-9 lg:h-10 rounded-lg border animate-pulse",
                    ...
                    <div className="pt-4 lg:pt-6 space-y-3">
                      <div className={cn(
                        "h-8 lg:h-9 rounded-lg w-24 lg:w-32 animate-pulse",
                        isLightTheme ? "bg-gray-200" : "bg-gray-700"
                      )}></div>
                      <div className={cn(
                        "h-8 lg:h-9 rounded-lg w-full animate-pulse",
                        isLightTheme ? "bg-gray-100" : "bg-gray-800"
                      )}></div>
                    </div>
                  </div>
              ...
              <div className="space-y-4 lg:space-y-6">
                ...
                <div className={cn(
                  ...
                  <div className="p-4 lg:p-6">
                    <div className={cn(
                      "h-5 lg:h-6 rounded w-32 lg:w-40 animate-pulse mb-4 lg:mb-6",
                      isLightTheme ? "bg-gray-200" : "bg-gray-700"
                    )}></div>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <div className={cn(
                          "h-3 lg:h-4 rounded w-20 lg:w-24 animate-pulse",
                          isLightTheme ? "bg-gray-100" : "bg-gray-800"
                        )}></div>
                        <div className={cn(
                          "h-3 lg:h-4 rounded w-16 lg:w-20 animate-pulse",
                      ...
                      <div className="flex justify-between items-center">
                        <div className={cn(
                          "h-3 lg:h-4 rounded w-18 lg:w-20 animate-pulse",
                          isLightTheme ? "bg-gray-100" : "bg-gray-800"
                        )}></div>
                        <div className={cn(
                          "h-3 lg:h-4 rounded w-14 lg:w-16 animate-pulse",
                          isLightTheme ? "bg-gray-200" : "bg-gray-700"
                        )}></div>
                      </div>
                    </div>
                ...
                <div className={cn(
                  ...
                  <div className="p-4 lg:p-6">
                    <div className={cn(
                      "h-5 lg:h-6 rounded w-20 lg:w-24 animate-pulse mb-4 lg:mb-6",
                      isLightTheme ? "bg-gray-200" : "bg-gray-700"
                    )}></div>
                      ...
                      {[1, 2, 3].map((i) => (
                        <div key={i} className={cn(
                          ...
                          <div className="flex items-center space-x-3">
                            <div className={cn(
                              "h-5 w-5 lg:h-6 lg:w-6 rounded animate-pulse",
                              isLightTheme ? "bg-gray-200" : "bg-gray-700"
                            )}></div>
                            <div className="flex-1 space-y-2">
                              <div className={cn(
                                "h-5 lg:h-6 rounded w-8 lg:w-12 animate-pulse",
                                isLightTheme ? "bg-gray-200" : "bg-gray-700"
                              )}></div>
                              <div className={cn(
                                "h-3 lg:h-4 rounded w-12 lg:w-16 animate-pulse",
